...
from mmyolo.models.detectors.feat_enhancer import FeatEnHancer
...
class YOLOFeatEnhancerDetector(SingleStageDetector):
    ...
    def __init__(self,
        ...
        super().__init__(
            ...
            init_cfg=init_cfg)
        self.feat_enhancer = FeatEnHancer()
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        batch_inputs_enhanced = self.feat_enhancer(batch_inputs)
        ...
        x = self.extract_feat(batch_inputs_enhanced)
