...
data_root = '../data/VOC2012/'  # Root path of data
# Path of train annotation file
train_ann_file = 'annotations/train.json'
train_data_prefix = 'JPEGImages-FOG-0.1/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/val.json'
val_data_prefix = 'JPEGImages-FOG-0.1/'  # Prefix of val image path
metainfo = {
    ...
    'palette': [
        ...
        (29, 123, 243), (0, 255, 255), (101, 205, 128), (240, 128, 28),
        (154, 205, 0), (34, 139, 200), (139, 0, 255), (255, 165, 150),
        (255, 150, 255), (255, 255, 150), (29, 123, 143), (150, 255, 255)
    ]
}
...
val_batch_size_per_gpu = 2 * batch_size
...
param_scheduler = [
    dict(
        type='mmengine.optim.scheduler.MultiStepLR',
        begin=0,
        end=max_epochs,
        by_epoch=True,
        milestones=list(range(interval_epoch, max_epochs, interval_epoch)),
        gamma=gamma)
]
