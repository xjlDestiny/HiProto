...
def parse_args():
    ...
    parser.add_argument(
        '--config',
        default='../old-best-record/work_dirs-yolov8_osp-exdark-noFE--b8-300e-0.01-specific_levels-BGProto-(5)-2/'
                'yolov8_osp_s_syncbn_fast_exdark-noFE--b8-300e-0.01/yolov8_osp_s_syncbn_fast_exdark-noFE--b8-300e-0.01.py',
        help='test config file path'
    )
    parser.add_argument(
        '--checkpoint',
        default='../old-best-record/work_dirs-yolov8_osp-exdark-noFE--b8-300e-0.01-specific_levels-BGProto-(5)-2'
                '/yolov8_osp_s_syncbn_fast_exdark-noFE--b8-300e-0.01/epoch_110.pth',
