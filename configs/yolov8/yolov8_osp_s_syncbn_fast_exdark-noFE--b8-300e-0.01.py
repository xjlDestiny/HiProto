...
# -----data related-----
dataset_name = 'Exdark'
data_root = '/Home/destiny/mmdetection_9/tests/data/Exdark_Voc/'  # Root path of data
# Path of train annotation file
train_ann_file = 'annotations/train.json'
train_data_prefix = 'JPEGImages/IMGS/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/val.json'
val_data_prefix = 'JPEGImages/IMGS/'  # Prefix of val image path
metainfo = {
    'classes': ("Bicycle", "Boat", "Bottle", "Bus", "Car", "Cat",
                "Chair", "Cup", "Dog", "Motorbike", "People", "Table"),
    'palette': [
        (101, 205, 228), (240, 128, 128), (154, 205, 50), (34, 139, 34),
        (0, 255, 255), (255, 165, 0), (255, 0, 255), (255, 255, 0),
        (29, 123, 243), (139, 0, 0), (101, 205, 128), (240, 128, 28)
    ]
}
