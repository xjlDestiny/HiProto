...
class ClassificationHead(nn.Module):
    ...
    def forward(self, x):
        ...
        return instance_vectors, cls_logit


class RegressionHead(nn.Module):
    def __init__(self, in_channels, reg_out_channels,
                 reg_max, norm_cfg, act_cfg):
        super().__init__()
        ...
        for i in range(self.num_levels):
            ...
            self.reg_preds.append(
                RegressionHead(
                    ...
                    self.reg_max, self.norm_cfg, self.act_cfg
                )
            )
...
class YOLOv8Head(YOLOv5Head):
    ...
    def predict(self,
        ...
        predictions = self.predict_by_feat(
            cls_logit, bbox_preds, batch_img_metas=batch_img_metas, rescale=rescale)
    ...
    def loss_by_feat(
        ...
        # todo 如果特征图尺寸发生变化（可能是由于多尺度训练或者输入图像大小变化），就需要重新生成先验框。
